...
export const constantRoutes = [
  {
    ...
    children: [
      {
        path: 'menu', // When clicking this submenu, it will redirect to /#/foo/index
        component: () => import('@/views/navigation/MenuController'),
        name: 'menu',
        meta: { title: 'Меню' }, // foo submenu
      },
      {
        path: 'test', // When clicking this submenu, it will redirect to /#/foo/bar
        component: () => import('@/views/charts/Keyboard'),
        name: 'test',
        meta: { title: 'Тест' }, // bar submenu
      },
      // {
      //   path: 'menu-foto', // When clicking this submenu, it will redirect to /#/foo/bar
      //   component: () => import('@/views/navigation/MenuFoto'),
      //   name: 'menu-foto',
      //   meta: { title: 'Меню+Фото' }, // bar submenu
      // },
    ],
  },
